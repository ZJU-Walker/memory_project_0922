...
#   [JOB=17315830] [GPUS=4] [BATCH=8] [ACCUM=1] [CPUS=8] cluster_v6/run_train_hgx1.sh <config-name> <exp-name> [extra train.py args]
...
srun --jobid="$JOB" --overlap --nodes=1 --ntasks=1 --cpus-per-task="${CPUS:-8}" --gres=gpu:"$gpus" \
