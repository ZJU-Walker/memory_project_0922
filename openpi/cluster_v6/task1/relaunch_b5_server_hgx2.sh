#!/usr/bin/env bash
# Run ON iris-hgx-2: (re)launch the B5-500 robot server with 12 CPUs and 6 flow steps if none is running.
...
if [ "$n" = "0" ]; then
  ...
  JOB=17329416 GRES=1 GPU=0 CPUS=12 NO_PLACEHOLDER=1 SERVE_EXTRA='--num-steps 6' LOG=/iris/u/kewalk/memory_project_v6/v6/diagnostics/server_v6_b5_500_20260909c.log \
