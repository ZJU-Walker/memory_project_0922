#!/usr/bin/env bash
# v2 (three write modes: oracle, oracle_evidence = recall test, self). Run ON iris-hgx-2 (job 17329416): development battery on every stage-B checkpoint of v6_task1B_20260908_r1 as it
...
for step in 250 500 750 1000 1250 1500 1750 2000; do
  ...
  MODES=oracle_evidence JOB=17329416 GPU=0 bash $cv6/task1/run_task1_evals_hgx1.sh $bcfg $bexp $step &
