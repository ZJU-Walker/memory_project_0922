#!/usr/bin/env bash
# Generic task1 gate v4 = "launch first" (user 2026-09-09 11:00: "if A reaches 250 directly start training B3"): as soon
...
say "gate v4 armed on $(hostname): $AEXP ckpt $LAUNCH_B_AT -> $BEXP immediately (no gate), A battery afterwards; sidecar $(basename $SIDECAR)"
